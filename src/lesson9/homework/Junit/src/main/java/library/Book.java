...
public class Book implements Serializable {
    ...
    public boolean equals(Book b){
        return (b.id == id) && (b.authorName.equals(authorName)) && (b.bookName.equals(bookName)) && (b.cost == cost) && (b.numberOfPages == numberOfPages) && (b.publishingHouse.equals(publishingHouse)) && (b.yearOfPublishing == yearOfPublishing);
    }
}
