...
public class Book {
    ...
    public void view(){
        System.out.println("ID: " + id + " name: " + bookName + " author: " + authorName +
                " publishing house: " + publishingHouse + " year of publishing: " +
                yearOfPublishing + " number of pages: " + numberOfPages + " cost: " + cost);
    }
}
